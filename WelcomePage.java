...
public class WelcomePage extends javax.swing.JFrame {
	...
	public void loadRecognizer() {
		...
		configuration.setGrammarName("terminal");
		configuration.setUseGrammar(true);
		
		//configuration.setDictionaryPath("http://www.speech.cs.cmu.edu/tools/product/1620224582_12374/2263.dic");
		//configuration.setLanguageModelPath("http://www.speech.cs.cmu.edu/tools/product/1620224582_12374/2263.lm");
			...
			try {
				while (true) {
					...
					if (speechResult != null) {
						...
						{
						String commands[]= {"date","display content","password change","users","logged users","memory available","disk space available","used disk space","make directory","remove directory","super user","hardware information","battery information","list all files","system information","current directory","present working directory","process status","directory"};
						String tercmd[]= {"date","cat --help","passwd --help","users","w","free","df","df","mkdir --help","rmdir --help","sudo","lshw","upower -i /org/freedesktop/UPower/devices/battery_BAT0","ls","lscpu","pwd","pwd","ps","dir"};
						int flagvar=1;
						System.out.println(commands.length+" "+tercmd.length);
...
//							replyResult = r.commonReply(10);
				...
				textArea.setText("An Error Occured!!\nSpeechThread has exited!!");
			}
